...
public class OrpParser implements RecordParser<Orp> {
    ...
    public OrpParser(Element element) {
    ...
    @Override
    public Orp parse() throws ParseException {
        ...
        return new Orp(kod, nazev, nespravny, spravniObecKod, kodOkresu, platiOd, platiDo, idTransakce,
