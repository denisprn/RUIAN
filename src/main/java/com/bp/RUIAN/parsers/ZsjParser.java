...
public class ZsjParser implements RecordParser<Zsj> {
    ...
    public ZsjParser(Element element) {
    ...
    @Override
    public Zsj parse() throws ParseException {
        ...
        return new Zsj(kod, nazev, nespravny, kodKatastralniUzemi, platiOd, platiDo, idTransakce,
